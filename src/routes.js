...
const routes = [
  { label: 'Home', route: '/', navbarRenderer: NavButton, viewRenderer: Home, requiresAuth: false },
...
export default loggedIn => routes.filter(({ requiresAuth }) => loggedIn || !requiresAuth)